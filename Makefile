...
abs_srcdir=	/Users/Peter/Desktop/cpython-3.9
abs_builddir=	/Users/Peter/Desktop/cpython-3.9
...
CONFIGURE_CPPFLAGS=	-I/opt/homebrew/opt/zlib/include
CONFIGURE_LDFLAGS=	-L/opt/homebrew/opt/zlib/lib
...
CONFIG_ARGS=	 '--with-openssl=/opt/homebrew/opt/openssl@3' '--with-pydebug' 'LDFLAGS=-L/opt/homebrew/opt/zlib/lib' 'CPPFLAGS=-I/opt/homebrew/opt/zlib/include'
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.9/config-$(VERSION)$(ABIFLAGS)-darwin
